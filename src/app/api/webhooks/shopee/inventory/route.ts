/**
 * Shopee Inventory Webhook Endpoint
 * 
 * Captures inventory-related webhooks from Shopee:
 * - Stock updates
 * - Product updates
 * - Price changes
 */
...
export async function POST(req: NextRequest) {
  try {
    ...
    const eventType: string = ((payload as any).event_type as string) ?? "inventory.unknown";
    ...
    console.error("Error processing Shopee inventory webhook:", error);
